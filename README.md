...
**Not established.** Nobody has run an update against these three, so nothing is printed here
rather than a guess that fails quietly. Reinstalling with the steps at the top of this file is
the honest fallback.
